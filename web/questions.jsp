...
<div class="content-area" >
    ...
    <div class="panel form-style-6" style="margin: 10px 50px; max-width: 620px!important; float: left">   
        <form action="controller.jsp" >
            ...
            <table >
                <tr>
                    ...
                    <td colspan="3"> 
                        <select name="coursename" class="text" style="width: 420px">
                            <% 
                ...
                <tr>
                    ...
                    <td><input type="text" name="opt1" class="text" placeholder="First Option" style="width: 120px;" ></td>
                    <td><input type="text" name="opt2" class="text" placeholder="Second Option" style="width: 120px;" ></td>
                    <td><input type="text" name="opt3" class="text" placeholder="Third Option" style="width: 120px;" ></td>
                    <td><input type="text" name="opt4" class="text" placeholder="Fourth Option" style="width: 120px;" ></td>
                </tr>
                <tr>
                    <td><label>Correct Answer</label></td>
                    <td colspan="4"><center><input type="text" name="correct" class="text" placeholder="Correct Answer" style="width: 150px;" ></center></td>
                <tr>
